...
exports.initializeHTTP = void 0;
var display_1 = require("akuma-microservice-framework/lib/infrastructure/display");
var express = require('express');
var initializeHTTP = function (config, actions, securityAccess, app) {
...
var connect = function (config, actions, securityAccess, app) {
    var server = startServer(actions, securityAccess, app);
    server.listen(config.port, function () {
        (0, display_1.printStartService)('Server HTTP on port', String(config.port));
    });
};
function startServer(actions, securityAccess, app) {
    var _this = this;
    var server = express();
    ...
    var path = '/service';
    server.post(path, function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var start, action, actionName, dataResponse, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, action.run(req.body.data)];
                case 2:
